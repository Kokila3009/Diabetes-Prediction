...
<style>
body {
    background-color: #5FD5D3 ;  /* Replace with your desired color code */
}
</style>
"""
...
# HEADINGS
st.title('Welcome to Diab Detecto')
st.subheader('Check your DIabetes')
...
# Convert user_data to a NumPy array before predicting
...
cv_scores = cross_val_score(rf, x, y, cv=5)  # cv=5 for 5-fold cross-validation
average_cv_score = cv_scores.mean()

st.subheader('Cross-Validation Score:')
st.write(f"Average Cross-Validation Score: {average_cv_score}")
